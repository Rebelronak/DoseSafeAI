...
if __name__ == '__main__':
    ...
    if groq_api_key:
        ...
        print("   • Comprehensive medicine database (50,000+ entries)")
        print("   • Sophisticated drug interaction analysis")
        print("   • Professional-grade clinical explanations")
        print("   • Patient-specific warning system")
    else:
        print("Groq API key configuration: MISSING")
        print("Please add GROQ_API_KEY to your .env file for AI functionality")
    
    print("=" * 60)
    print("Server Status: Starting on http://127.0.0.1:5000")
    print("API Documentation Available:")
    print("   • System capabilities: http://127.0.0.1:5000/ai-capabilities")
